...
spawn(function()
  while task.wait() do
    ...
    Test.Name = "highlight"
    Test.Enabled = true
    Test.FillColor = Color3.fromRGB(0, 191, 255)
    Test.OutlineColor = Color3.fromRGB(255, 20, 147)
    Test.FillTransparency = 0.5
    Test.OutlineTransparency = 0.5
...
local Tabs = {
  Main = Window:AddTab({Title = "Main Page", Icon = ""}),
  Settings = Window:AddTab({Title = "Settings Page", Icon = ""}),
  Melee = Window:AddTab({Title = "Melee Page", Icon = ""}),
  Quests = Window:AddTab({Title = "Quests Page", Icon = ""}),
  SeaEvent = Window:AddTab({Title = "Sea Events Page", Icon = ""}),
  Mirage = Window:AddTab({Title = "Race Page", Icon = ""}),
  Drago = Window:AddTab({Title = "Draco Page", Icon = ""}),
  Prehistoric = Window:AddTab({Title = "Prehistoric Page", Icon = ""}),
  Raids = Window:AddTab({Title = "Raid Page", Icon = ""}),
  Combat = Window:AddTab({Title = "Combat Page", Icon = ""}),
  Travel = Window:AddTab({Title = "Teleport Page", Icon = ""}),
  Fruit = Window:AddTab({Title = "Fruits Page", Icon = ""}),
  Shop = Window:AddTab({Title = "Shop Page", Icon = ""}),
  Misc = Window:AddTab({Title = "Misc Page", Icon = ""})
}
Tabs.Main:AddSection("Discord")
Tabs.Main:AddButton({
        Title="HNC-Hub | Discord Community",
        Description="https://discord.gg/wa52S9VvPP",
        Callback=function()
            setclipboard(tostring("https://discord.gg/wa52S9VvPP")) 
        end
})
Tabs.Main:AddSection("Tik Tok")
Tabs.Main:AddButton({
        Title="HNC Roblox",
...
Tabs.Main:AddButton({
        Title="Open the fishing menu",
        Description="",
        Callback=function()
        loadstring(game:HttpGet("https://pandadevelopment.net/virtual/file/b07c3192fa96841d"))() 
        end
})
Tabs.Main:AddSection("Level - 1-2800")
...
Tabs.Main:AddSection("Boss Tyrant of the Skies")

local TyrantStatus = Tabs.Main:AddParagraph({
...
local FarmTyrant = Tabs.Main:AddToggle("FarmTyrant", {Title = "Farm Tyrant of the Skies", Description = "", Default = false})
FarmTyrant:OnChanged(function(Value) _G.FarmTyrant = Value end)
...
local FarmPhaBinh = Tabs.Main:AddToggle("FarmPhaBinh", {Title = "Break the Bottle and Summon Boss", Description = "", Default = false})
...
spawn(function()
    while wait(Sec) do
        if _G.FarmPhaBinh then
            pcall(function()
                pcall(function() if AutoHaki then AutoHaki() end end)
                ...
                for _, point in ipairs(PhaBinhPoints) do
                    ...
                    while tick() - start < 12 and not arrived and _G.FarmPhaBinh do
                        ...
                        if not hrp or not plr.Character or not plr.Character:FindFirstChild("Humanoid") or plr.Character.Humanoid.Health <= 0 then break end
...
local Initialize = Tabs.Settings:AddToggle("Initialize", {Title = "Fast Attck/M1 Fruit", Description = "", Default = true})
...
Toggle = Tabs.Drago:AddToggle("Toggle", {Title = "Auto Draco (V1)", Description = "", Default = false})
Toggle:OnChanged(function(Value)
  _G.DragoV1 = Value
end)
spawn(function()
...
local fireflower = Tabs.Drago:AddToggle("fireflower", {Title = "Auto Draco (V2)", Description = "", Default = false})
...
Toggle = Tabs.Drago:AddToggle("Toggle", {Title = "Auto Draco (V3)", Description = "", Default = false})
Toggle:OnChanged(function(Value)
  _G.DragoV3 = Value
end)
spawn(function()
...
Toggle = Tabs.Drago:AddToggle("Toggle", {Title = "Auto Relic Drago Trial", Description = "", Default = false})
Toggle:OnChanged(function(Value)
  _G.Relic123 = Value
end)
spawn(function()
...
walkWater = Tabs.Misc:AddToggle("walkWater", {Title = "Walk on Water", Description = "", Default = true})
...
iceWalk = Tabs.Misc:AddToggle("iceWalk", {Title = "Ice Walk", Description = "", Default = false})
